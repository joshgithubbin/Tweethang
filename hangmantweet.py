...
api = twitter("w63UpGM6a6MLXGOfq4IDCEZhF","PRxf0gDKbZkX84nGfiaMSh3DSZhqy7wwYDS3Co2OWqP1rRyDqe","463208270-sNmeCDuu3Sr6oOzlcbwjTeijKE3bQ1t5i2mwcVhG","QdjQyjsixRabRTKJRH8yEoz8ymbhoWMY0OrziATiVZkkY")
...
while True:
    print('in loop!')
    dm = api.list_direct_messages(3)
    print('recovered message')
    message = readmessage(dm)
    stamp = message.id_
    if message.text == 'hangman':
        print('made it to game')
        hangman(message.sender_id,stamp)
    time.sleep(60)